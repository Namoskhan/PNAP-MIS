  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'pending', icon: '⏳', title: 'Member Approvals', description: 'Review and approve new member registrations.', route: '/members?status=PENDING_APPROVAL', show: () => hasPermission(user, 'APPROVE_MEMBER') },
