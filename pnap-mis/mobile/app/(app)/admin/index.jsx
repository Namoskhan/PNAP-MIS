...
export default function AdminHubScreen() {
  ...
  const isDistrict = hasRole(user, 'DISTRICT_ADMIN') && !isSuper && !hasRole(user, 'PROVINCE_ADMIN') && !hasRole(user, 'CENTRAL_ADMIN');
  const isArea = hasRole(user, 'AREA_ADMIN') && !isHigherAdmin(user);
  ...
  const sections = [
    ...
    // 3. Province Admin: My Province (KPK Admin Hub)
    {
      ...
      items: [
        ...
        { key: 'p-org', icon: '🏢', title: 'Manage Districts', description: 'Create and manage district tier units in your province.', route: '/admin/manage-org' },
        ...
        { key: 'p-cab', icon: '🏛️', title: 'Cabinet & Office-Holders', description: 'Manage provincial cabinet and appoint district roles.', route: '/cabinet' },
